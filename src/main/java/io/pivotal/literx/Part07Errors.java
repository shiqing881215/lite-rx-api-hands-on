...
public class Part07Errors {
  ...
  // this is to handle CheckedException (GetOutOfHereException)
  // Exceptions.propagate(checkedException) convert checkedException -> RuntimeException so compiler doesn't complain
